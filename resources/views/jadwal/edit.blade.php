<x-app-layout>
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Perbarui informasi jadwal perkuliahan.</p>
        </div>
    </div>
        ...
        <form action="{{ route('jadwal.update', $jadwal->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="mata_kuliah" id="mata_kuliah" value="{{ old('mata_kuliah', $jadwal->mata_kuliah) }}" class="w-full rounded-xl border-gray-300 focus:border-primary focus:ring-primary shadow-sm" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="dosen" id="dosen" value="{{ old('dosen', $jadwal->dosen) }}" class="w-full rounded-xl border-gray-300 focus:border-primary focus:ring-primary shadow-sm" required>
                ...
                <div>
                    ...
                    <input type="text" name="ruangan" id="ruangan" value="{{ old('ruangan', $jadwal->ruangan) }}" class="w-full rounded-xl border-gray-300 focus:border-primary focus:ring-primary shadow-sm" required>
                ...
                <div>
                    ...
                    <input type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai', \Carbon\Carbon::parse($jadwal->jam_mulai)->format('H:i')) }}" class="w-full rounded-xl border-gray-300 focus:border-primary focus:ring-primary shadow-sm" required>
                ...
                <div>
                    ...
                    <input type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai', \Carbon\Carbon::parse($jadwal->jam_selesai)->format('H:i')) }}" class="w-full rounded-xl border-gray-300 focus:border-primary focus:ring-primary shadow-sm" required>
            ...
            <div class="mt-8 flex justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 bg-primary text-white rounded-xl font-medium hover:bg-red-800 transition-colors shadow-sm">Update Jadwal</button>
            </div>
        </form>
    </div>
</x-app-layout>